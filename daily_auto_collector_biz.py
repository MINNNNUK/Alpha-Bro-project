...
# -*- coding: utf-8 -*-
"""
매일 자동으로 기업마당 공고 데이터를 수집하는 스크립트
...
from bizinfo_2025_collector import BizInfo2025Collector
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('daily_auto_collector_biz.log', encoding='utf-8'),
...
def weekly_collection():
    ...
    try:
        logger.info("=== 매주 30일간 데이터 수집 시작 (기업마당) ===")
...
def monthly_collection():
    ...
    try:
        logger.info("=== 매월 1년간 데이터 수집 시작 (기업마당) ===")
